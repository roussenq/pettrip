    ...
    create table tb_establishment_filters (
       establishment_id bigint not null,
        filters_id bigint not null
    ) engine=InnoDB;

    create table tb_filters (
       id bigint not null auto_increment,
        castrated varchar(11),
        gender varchar(6),
        type varchar(3),
        weight varchar(4),
        primary key (id)
    ...
    alter table tb_establishment 
       add constraint UK_iatffwjlo8nk5kettd0a9969n unique (cnpj);
    ...
    alter table tb_establishment 
       add constraint FK772pc11dtq2hyr643fiy1pyec 
       foreign key (address_id) 
       references tb_address (id);

    alter table tb_establishment_filters 
       add constraint FKsi39fotplmtls4s40ftqrg0oc 
       foreign key (filters_id) 
       references tb_filters (id);

    alter table tb_establishment_filters 
       add constraint FKpr4aqr0wo9igkww5wyi1bhdnl 
       foreign key (establishment_id) 
       references tb_establishment (id);
